...
public class MonomHalbgruppe implements Halbgruppe<Monom>,
		KommutativesMagma<Monom> {
	
	
	static public MonomHalbgruppe P2Z = new MonomHalbgruppe("p","q","r","s","t","u","v","w","x","y","z");
	...
	public int getIndex(String key) {
		...
		throw new RuntimeErrorException(null,"Der Bezeichner " + key + " wurde nicht gefunden");
	}
